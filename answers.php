						...
						<ul class="w-100 list-group" id="topic-list">
							...
							<li class="list-group-item mb-4">
								<div>
									...
									<?php if($_SESSION['login_id'] != $row['user_id']): ?> <span class="badge badge-info text-white ml-2">Click Question Title to Answer >>> </span> <a href="index.php?page=post_answer&id=<?php echo $row['id'] ?>"
									 class=" filter-text"><?php echo $row['title'] ?></a><?php endif; ?>
